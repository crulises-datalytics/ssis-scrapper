CREATE PROCEDURE [dbo].[spCMS_BatchLoad_StagingToEDW_FactLifecycleStatusSnapshot]
	@EDWRunDateTime DATETIME2 = NULL,
	@DebugMode      INT       = NULL
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCMS_BatchLoad_StagingToEDW_FactLifecycleStatusSnapshot
    --
    -- Purpose:            Performs the Insert / Update / Delete ETL process for
    --                         the FactLifecycleStatusSnapshot table from Staging to BING_EDW, loading
    ...
    --                         core logic.
    --                     @DaysBack - For FactLifecycleStatusSnapshot load we have to go back and potentially reporcess
    ...
    --
    --
    --Usage:              EXEC dbo.spCMS_BatchLoad_StagingToEDW_FactLifecycleStatusSnapshot
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
         ...
         BEGIN TRY
		   ...
		   -- ================================================================================
			 ...
			 INSERT INTO @SourceFiscalDate(FiscalDate)
                 SELECT DISTINCT AsOfFiscalWeekEndDate
                 FROM dbo.LifecycleStatusSnapshot(NOLOCK)
		   ...
		   --
             ...
             WHILE @@FETCH_STATUS = 0
				 ...
				 -- ================================================================================
                     EXEC dbo.spCMS_StagingToEDW_FactLifecycleStatusSnapshot
                          @AuditId = @AuditId,
