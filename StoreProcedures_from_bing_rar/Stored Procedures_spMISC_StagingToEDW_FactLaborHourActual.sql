...
CREATE PROCEDURE [dbo].[spMISC_StagingToEDW_FactLaborHourActual]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spMISC_StagingToEDW_FactLaborHourActual
    --
    ...
    BEGIN
        ...
        BEGIN TRY
            ...
            EXEC dbo.spMISC_StagingTransform_FactLaborHourActual 
