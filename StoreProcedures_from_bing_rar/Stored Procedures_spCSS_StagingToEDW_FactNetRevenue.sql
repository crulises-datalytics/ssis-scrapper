CREATE PROCEDURE [dbo].[spCSS_StagingToEDW_FactNetRevenue]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCSS_StagingToEDW_FactNetRevenue
    --
    ...
    --                         sub-procedure spCSS_StagingTransfrom_FactNetRevenue, 
	    ...
	    -- --------------------------------------------------------------------------------
         BEGIN TRY
		   ...
		   -- ================================================================================
             ...
             EXEC dbo.spCSS_StagingTransform_FactNetRevenue
