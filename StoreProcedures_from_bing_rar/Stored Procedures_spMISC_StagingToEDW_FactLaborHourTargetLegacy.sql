...
(
    ...
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spMISC_StagingToEDW_FactLaborHourTarget'
)
    DROP PROCEDURE dbo.spMISC_StagingToEDW_FactLaborHourTarget;
GO
*/

CREATE PROCEDURE [dbo].[spMISC_StagingToEDW_FactLaborHourTargetLegacy]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spMISC_StagingToEDW_FactLaborHourTargetLegacy
    --
    ...
    --
    --
    -- Usage:              EXEC dbo.spMISC_StagingToEDW_FactLaborHourTargetLegacy @FiscalWeekEndDate = '20171231'
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
	    ...
	    -- --------------------------------------------------------------------------------
         BEGIN TRY
		   ...
		   -- ================================================================================
             ...
             EXEC dbo.spMISC_StagingTransform_FactLaborHourTargetLegacy
