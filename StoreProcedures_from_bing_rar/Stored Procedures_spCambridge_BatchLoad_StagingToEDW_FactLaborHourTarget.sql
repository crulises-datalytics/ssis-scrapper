CREATE PROCEDURE [dbo].[spCambridge_BatchLoad_StagingToEDW_FactLaborHourTarget]
	@EDWRunDateTime DATETIME2 = NULL,
	@DebugMode      INT       = NULL
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCambridge_BatchLoad_StagingToEDW_FactLaborHourTarget
    --
    ...
    --
    --
    --Usage:              EXEC dbo.spCambridge_BatchLoad_StagingToEDW_FactLaborHourTarget
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
	...
	-- 12/03/18			schwegner			bng-4221 -  adding cambridge source	
	--12/11/18			schwenger			bng-4488 - updatedd taskname	
         ...
         BEGIN TRY
		   ...
		   -- ================================================================================
             ...
             FOR
				 ...
				 WHERE FiscalWeekEndDate  < '2021-03-06'
		   ...
		   --
             ...
             WHILE @@FETCH_STATUS = 0
				 ...
				 -- ================================================================================
                     EXEC dbo.spCambridge_StagingToEDW_FactLaborHourTarget
                          @AuditId = @AuditId,
