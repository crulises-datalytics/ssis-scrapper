...
(
    ...
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spSalesForce_StagingEDWETLBatchControl'
)
    DROP PROCEDURE dbo.spSalesForce_StagingEDWETLBatchControl;
GO
*/
CREATE PROCEDURE [dbo].[spSalesForce_StagingEDWETLBatchControl](@TaskName VARCHAR(100))
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spSalesForce_StagingEDWETLBatchControl
    --
    ...
    -- ----        -----------        --------
    --
    -- 02/03/18    hhebbalu           Initial version of proc
    --			 
    -- ================================================================================
     BEGIN
         SET NOCOUNT ON;
