CREATE PROCEDURE dbo.spCSS_StagingToEDW_FactARBalanceSnapshot
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCSS_StagingToEDW_FactARBalanceSnapshot
    --
    ...
    --                         sub-procedure spCSS_StagingTransform_FactARBalanceSnapshot, 
    ...
    --
    --
    -- Usage:              EXEC dbo.spCSS_StagingToEDW_FactAdjustment @EDWRunDateTime = @EDWRunDateTime, @DebugMode = 1
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
    ...
    -- ================================================================================
     BEGIN
	    ...
	    --                         -----  
	    --
	    -- There is also a CMS version of the proc spCSS_StagingToEDW_FactAdjustment
	    ...
	    -- --------------------------------------------------------------------------------
         BEGIN TRY
		   ...
		   -- ================================================================================
             ...
             EXEC dbo.spCSS_StagingTransform_FactARBalanceSnapshot
