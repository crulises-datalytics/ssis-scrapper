CREATE PROCEDURE dbo.spCSS_StagingToEDW_DimTuitionAssistanceProvider
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCSS_StagingToEDW_DimTuitionAssistanceProvider
    --
    ...
    --
    -- Usage:              EXEC dbo.spCSS_StagingToEDW_DimTuitionAssistanceProvider @DebugMode = 1	
    -- 
    --
    -- --------------------------------------------------------------------------------
    --
    ...
    -- ================================================================================
     BEGIN
	    ...
	    --
         ...
         DECLARE @SourceName VARCHAR(100)= 'DimTuitionAssistanceProvider - CSS';
	    ...
	    --
         ...
         ([SourceSystem], [CSSCenterNumber] ASC, [CSSCustomerCode] ASC
         );
         ...
         BEGIN TRY
		   ...
		   --
             ...
             ON(S.SourceSystem = T.SourceSystem
                ...
                AND S.CSSCustomerCode = T.CSSCustomerCode)
                 WHEN MATCHED AND(S.TuitionAssistanceProviderID <> T.TuitionAssistanceProviderID
                                  OR S.TuitionAssistanceProviderName <> T.TuitionAssistanceProviderName
                 ...
                 THEN UPDATE SET
                                 T.TuitionAssistanceProviderID = S.TuitionAssistanceProviderID,
