CREATE PROCEDURE dbo.spCSS_StagingToEDW_DimClassroom
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCSS_StagingToEDW_DimClassroom
    --
    ...
    --
    -- Usage:              EXEC dbo.spCSS_StagingToEDW_DimClassroom @DebugMode = 1	
    -- 
    --
    -- --------------------------------------------------------------------------------
    --
	...
	-- 12/04/17    sburke              Bug fix on #DimClassroomUpsert MERGE statement (BNG-639)
    --			 
    -- ================================================================================
     BEGIN
         SET NOCOUNT ON;
	    ...
	    --
         ...
         DECLARE @SourceName VARCHAR(100)= 'DimClassroom - CSS';
	    ...
	    -- --------------------------------------------------------------------------------
         BEGIN TRY
		   ...
		   -- ================================================================================
             ...
             EXEC dbo.spCSS_StagingTransform_DimClassroom
                  @EDWRunDateTime;
		   ...
		   --
             ...
             ON(S.SourceSystem = T.SourceSystem
                ...
                AND S.ClassroomCapacity = T.ClassroomCapacity)
                 WHEN MATCHED AND S.Deleted IS NULL
                                  AND (S.ClassroomType <> T.ClassroomType
                                       OR S.ClassroomID <> T.ClassroomID
