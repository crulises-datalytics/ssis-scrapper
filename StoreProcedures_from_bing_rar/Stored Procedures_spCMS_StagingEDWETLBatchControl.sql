...
(
    ...
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spCMS_StagingEDWETLBatchControl'
)
    DROP PROCEDURE dbo.spCMS_StagingEDWETLBatchControl;
GO
*/
CREATE PROCEDURE dbo.spCMS_StagingEDWETLBatchControl(@TaskName VARCHAR(100))
AS
    -- ================================================================================
    -- 
