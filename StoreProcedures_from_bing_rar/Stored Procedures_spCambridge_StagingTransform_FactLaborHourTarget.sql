...
(
    ...
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spCambridge_StagingTransform_FactLaborHourTarget'
)
    DROP PROCEDURE dbo.spCambridge_StagingTransform_FactLaborHourTarget;
GO
*/
CREATE  PROCEDURE [dbo].[spCambridge_StagingTransform_FactLaborHourTarget]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCambridge_StagingTransform_FactLaborHourTarget
    --
    ...
    --                     EXEC dbo.spCambridge_StagingTransform_FactLaborHourTarget @FiscalWeekEndDate = '20171231'
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
    ...
    -- 11/15/2018	    schwenger			 BNG-4421 - add cambridge data to assimilate into fact labor hour table
	--12/10/2018		schwenger			bng-4488 - pointed to variable source sys
	    ...
	    --
         BEGIN TRY
			...
			--   ,lh.[Source] AS SourceSystem
               ...
               WHERE dm_d.FiscalWeekEndDate = @FiscalWeekEndDate AND dm_d.FiscalWeekNumber < 202109
         END TRY
	    --
