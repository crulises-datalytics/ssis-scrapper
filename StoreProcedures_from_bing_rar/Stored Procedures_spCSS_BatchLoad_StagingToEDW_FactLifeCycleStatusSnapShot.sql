CREATE PROCEDURE [dbo].[spCSS_BatchLoad_StagingToEDW_FactLifeCycleStatusSnapShot]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCSS_BatchLoad_StagingToEDW_FactLifeCycleStatusSnapShot
    --
    ...
    --
    --
    --Usage:              EXEC dbo.spCSS_BatchLoad_StagingToEDW_FactLifeCycleStatusSnapShot
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
    ...
    -- ================================================================================
         BEGIN
			 ...
			 */
             ...
             SELECT @LastProcessedDate = MAX(LastProcessedDate), @MinProcessingDate = MAX([MinProcessingDate])
             ...
             BEGIN TRY
                 ...
                 WHILE @@FETCH_STATUS = 0
                     BEGIN
                         ...
                         -- ================================================================================
                         EXEC dbo.spCSS_StagingToEDW_FactLifeCycleStatusSnapShot
                              @AuditId = @AuditId,
