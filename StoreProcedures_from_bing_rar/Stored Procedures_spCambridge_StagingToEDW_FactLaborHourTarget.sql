--spcambridge_statingtoedw_factlaborhourtarget
/*
IF EXISTS
(
    SELECT *
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spCambridge_StagingToEDW_FactLaborHourTarget'
)
    DROP PROCEDURE dbo.spCambridge_StagingToEDW_FactLaborHourTarget;
GO
*/

CREATE PROCEDURE [dbo].[spCambridge_StagingToEDW_FactLaborHourTarget]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCambridge_StagingToEDW_FactLaborHourTarget
    --
    ...
    --                         sub-procedure spCambridge_StagingTransfrom_FactLaborHour, 
    ...
    --
    --
    -- Usage:              EXEC dbo.spCambridge_StagingToEDW_FactAdjustment @FiscalWeekEndDate = '20171231'
    --
    -- -----------------------------------------------------------------------------------------------------------------------------------------------
    --
    -- Change Log:		   
    ...
    --12/03/2018		schwenger			bng-4221 - updating the procedure for cambridge
    --12/10/2018		schwenger			bng-4488 - updating the taskname from cms to pro for the audit log
    --10/18/2019		Puneet				Added SourceSystem in Delete before inserting data to FactLaborHour (BI-2609).
	-- 11/09/20     Adevabhakthuni  BI-3569 added two new fields to load to fact table	 
    -- ================================================================================
    BEGIN
        SET NOCOUNT ON;
        ...
        DECLARE @TaskName VARCHAR(100)= 'FactLaborHourTargetPRO';
        ...
        BEGIN TRY
            ...
            EXEC dbo.spCambridge_StagingTransform_FactLaborHourTarget 
