-- ================================================================================
    -- 
    -- Stored Procedure:   spFactWeeklyMeasureLoad_GLBalancePlanAllocation_NetRevenue
    --
    -- Purpose:            Inserting Dimesionkeys from DW_Landing.[GLBalancePlanAllocation_NetRevenueLanding]
	--                     to main table DW_Mart.[FactWeeklyMeasure] table.
    --
    -- Parameters:		   n/a
    --
    -- Usage:              exec dbo.spFactWeeklyMeasureLoad_GLBalancePlanAllocation_NetRevenue @FicalWeek =20220306
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
    ...
    -- ----------		-----------			--------
    --
    -- 20220306			Vishal Sawant		BI-4072 - Initial version
    --			 
    -- ================================================================================
CREATE PROCEDURE [dbo].[spFactWeeklyMeasureLoad_GLBalancePlanAllocation_NetRevenue]
@FicalWeek int
AS
BEGIN
...
SELECT 
  ...
  FROM [DW_Landing].[dbo].[GLBalancePlanAllocation_NetRevenueLanding] as a
