CREATE PROCEDURE [dbo].[spHR_StagingToEDW_FactEmployeeAssessment]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spHR_StagingToEDW_FactEmployeeAssessment
    --
    -- Purpose:            Performs the Insert / Update / Delete ETL process for
    --					  the FactEmployeeAssessment table from Staging to BING_EDW.
    --
    ...
    --
    --
    -- Usage:              EXEC dbo.spHR_StagingToEDW_FactEmployeeAssessment @EDWRunDateTime = @EDWRunDateTime, @DebugMode = 1
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
    ...
    -- ================================================================================
     BEGIN
	    ...
	    --
         ...
         DECLARE @SourceName VARCHAR(100)= 'FactEmployeeAssessment';
	    ...
	    -- --------------------------------------------------------------------------------
         BEGIN TRY
		   ...
		   --
             ...
             FROM BING_EDW.dbo.FactEmployeeAssessment;
             
			 Truncate table BING_EDW.dbo.FactEmployeeAssessment
		   ...
		   --
             INSERT INTO BING_EDW.dbo.FactEmployeeAssessment
             ( 
				  [DateKey]
                     ,[PersonKey]
                     ,[AssessmentTypeKey]
                     ...
                     ,[AssessmentID]
                     ,[EmployeeAssessmentFlexValue1]
                     ,[EmployeeAssessmentFlexValue2]
                     ,[EmployeeAssessmentFlexValue3]
                     ,[EmployeeAssessmentFlexValue4]
                     ,[EmployeeAssessmentFlexValue5]
                     ,[EmployeeAssessmentCreatedDate]
                     ,[EmployeeAssessmentCreatedUser]
                     ,[EmployeeAssessmentModifiedDate]
                     ,[EmployeeAssessmentModifiedUser]
                     ,[EDWCreatedDate]
             )
              EXEC [dbo].[spHR_StagingTransform_FactEmployeeAssessment];
