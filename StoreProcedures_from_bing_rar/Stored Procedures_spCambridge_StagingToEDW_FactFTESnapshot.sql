...
(
    ...
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spCambridge_StagingToEDW_FactFTESnapshot'
)
    DROP PROCEDURE dbo.spCambridge_StagingToEDW_FactFTESnapshot;
GO
*/
CREATE PROCEDURE [dbo].[spCambridge_StagingToEDW_FactFTESnapshot]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCambridge_StagingToEDW_FactFTESnapshot
    --
    ...
    --
    -- Usage:              EXEC dbo.spCambridge_StagingToEDW_FactFTESnapshot @DebugMode = 1  
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:         
    ...
    -- ----        -----------         --------
    --
    -- 01/13/18     anmorales          BNG-253 - EDW FactFTESnapshot: Created procedure
    --           
    -- ================================================================================
         BEGIN
             SET NOCOUNT ON;
        ...
        -- --------------------------------------------------------------------------------
           ...
           -- ================================================================================
                 ...
                 EXEC dbo.spCambridge_StagingTransform_FactFTESnapshot
