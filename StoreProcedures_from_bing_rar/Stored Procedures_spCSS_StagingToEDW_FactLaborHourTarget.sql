...
(
    ...
    FROM sys.objects
    WHERE type = 'P'
          AND name = 'spCSS_StagingToEDW_FactLaborHourTarget'
)
    DROP PROCEDURE dbo.spCSS_StagingToEDW_FactLaborHourTarget;
GO
*/

CREATE PROCEDURE [dbo].[spCSS_StagingToEDW_FactLaborHourTarget]
...
AS
    -- ================================================================================
    -- 
    -- Stored Procedure:   spCSS_StagingToEDW_FactLaborHourTarget
    --
    ...
    --                         sub-procedure spCSS_StagingTransfrom_FactLaborHour, 
    ...
    --
    --
    -- Usage:              EXEC dbo.spCSS_StagingToEDW_FactAdjustment @FiscalWeekEndDate = '20171231'
    --
    -- --------------------------------------------------------------------------------
    --
    -- Change Log:		   
	    ...
	    -- --------------------------------------------------------------------------------
         BEGIN TRY
		   ...
		   -- ================================================================================
             ...
             EXEC dbo.spCSS_StagingTransform_FactLaborHourTarget
